export const HomeSection = {
    ...
    content:`<p className="deskripsi">Belajar Programming </p>
                <h2>Jangan menyerah, Tetap Semangat</h2>
                <p>Kembangkan keterampilan baru dan tingkatkan kemampuan Anda. Jadilah bagian dari komunitas belajar yang dinamis dan rasakan perubahan luar biasa!</p>
